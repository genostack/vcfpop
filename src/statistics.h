...
public:
	...
	/* Draw a uniform distriubted interger */
	TARGET int Next(int min, int max);

	/* Draw a uniform distriubted interger */
	TARGET int Next(int max);

	/* Draw a uniform distriubted interger and avoid sample av */
	TARGET int NextAvoid(int max, int av);
	...
	TARGET void Dirichlet(double *res, double *a, double *b, int n);
